  ...
  return (
    ...
    >
      <div
        ...
        className="container  row g-0 flex-row-reverse px-5 py-3 pb-5 p-md-5  "
      >
        {/* 圖片區 */}
        ...
        <div className=" col-md-8 py-3 text-center text-md-start d-flex  justify-content-center flex-column">
          ...
          <div className="change2 hidden">
            ...
            <p className="ms-1 w-90 text-start d-none d-md-flex">
              學校在大一時，雖然有開設網頁相關的課程，但課程教授的內容僅停留在基礎的皮毛，所以在當時對網頁開發領域其實沒有產生實質興趣。真正對前端產生興趣的時間點，是在大三系上開始準備專題的時期，雖然我在組別分工當中被分配到的不是網頁開發的相關工作，但看到組員在開會中展現做出來的頁面，雖然現在回想，只是由HTML、CSS所簡單構成的靜態頁面，但在當時讓我感到非常驚艷，於是很積極的向組員請教，最終在被推坑網頁開發的線上課程後，就這樣踏入了前端世界！
            </p>
            <p className="w-100 ms-2 text-start d-flex d-md-none">
              真正對前端產生興趣的時間點，是在大三時，系上開始準備專題的時期，雖然我在組別分工當中分配到的工作不是網頁開發領域的相關，但看到組員在開會中展現他做出來的頁面，雖然現在回想，只是由HTML、CSS所簡單構成的靜態頁面，但當時讓我感到非常驚艷，於是在空閒之餘，很積極的向組員請教，最終在被組員推坑網頁開發的線上課程後，跟著一起踏入了前端世界！
            </p>
